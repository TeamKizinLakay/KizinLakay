...
public class RecyclerViewRecetteAdapter  extends RecyclerView.Adapter<RecyclerViewRecetteAdapter.ViewHolder>{
    ...
    private static List<com.example.thodlydugue.kizinlakayapp.Modele.recettes> recettes;
    private static Context context;


    // Provide a suitable constructor (depends on the kind of dataset)
    public RecyclerViewRecetteAdapter(Context context, ArrayList<com.example.thodlydugue.kizinlakayapp.Modele.recettes> recettes) {
